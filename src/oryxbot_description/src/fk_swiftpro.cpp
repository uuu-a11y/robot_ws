...
bool handle_forward_kinematics_request(oryxbot_description::FK::Request& req,
    oryxbot_description::FK::Response& res)
    {
...
int main(int argc, char** argv)
{
    ...
    ros::ServiceServer service = n.advertiseService("/oryxbot_description/forward_kinematics", handle_forward_kinematics_request);
